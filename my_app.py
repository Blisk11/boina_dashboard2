...
if pwd!= 'fractaldefou':
    ...
    logo = Image.open(r"C:\Users\julien\Documents\Python Scripts\boina_dashboard\LOGO LMDO petit.jpeg")

    t1.image(logo)
    t2.title("Dashboard demo: La maison de l'ostéopathie")

    df = pd.read_json(r"C:\Users\julien\Documents\Python Scripts\boina_dashboard\cleaned_df.json.gz", orient = 'index')
    df_copy = df.copy()
